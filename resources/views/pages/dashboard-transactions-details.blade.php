                ...
                <div class="col-12 col-md-8">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      @if ($transaction->getAttribute('shipping_status') === 'PENDING')
                      @php $shipping_status_color = 'text-danger'; @endphp
                      @elseif ($transaction->getAttribute('shipping_status') === 'COOKING')
                      @php $shipping_status_color = 'text-primary'; @endphp
                      @else
                      @php $shipping_status_color = 'text-success'; @endphp
                      @endif
                      <div class="product-subtitle {{ $shipping_status_color }}">
                        {{ $transaction->getAttribute('shipping_status') }}
                      </div>
                    </div>
                    <div class="col-12 col-md-6">
                      <div class="product-title">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle">
                        {{ $transaction->transaction->no_meja }}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="row">
                      ...
                      {{-- informasi lokasi shipping saya tutup dibagian ini
                      <div class="col-12 col-md-6">
